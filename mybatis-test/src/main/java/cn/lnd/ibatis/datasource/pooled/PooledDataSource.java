...
import cn.lnd.ibatis.datasource.unpooled.UnpooledDataSource;
...
/**
 * @Author lnd
 * @Description 实际场景下，我们基本不用 MyBatis 自带的数据库连接池的实现。所以，本文更多的目的，是让胖友们对数据库连接池的实现，有个大体的理解。
 * @Date 2024/9/16 23:27
 */
