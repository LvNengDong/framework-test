package cn.lnd.ibatis.datasource.pooled;
 ...
 * @Author lnd
 * @Description
 *      PooledConnection 是创建代理对象的前提，需要实现 InvocationHandler 接口
 *      真正的对象是 java.sql.Connection 实例
 * @Date 2024/9/16 23:29
 */
class PooledConnection implements InvocationHandler {
    ...
    /**
     * JDK Proxy 的接口，即 java.sql.Connection
     * */
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        // <1> 判断是否为 CLOSE 方法，如果是，则将连接放回到连接池中，避免连接被关闭
