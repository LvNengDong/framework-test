...
import cn.lnd.ibatis.exceptions.TooManyResultsException;
...
import cn.lnd.ibatis.executor.result.DefaultMapResultHandler;
...
public class DefaultSqlSession implements SqlSession {
    ...
    private Object wrapCollection(final Object object) {
        if (object instanceof Collection) {
            cn.lnd.ibatis.session.defaults.DefaultSqlSession.StrictMap<Object> map = new cn.lnd.ibatis.session.defaults.DefaultSqlSession.StrictMap<Object>();
