 ...
 * @Author lnd
 * @Description
 * @Date 2024/9/19 00:02
 */
public class ResultLoaderMap {

    private final Map<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair> loaderMap = new HashMap<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair>();
    ...
    public void addLoader(String property, MetaObject metaResultObject, ResultLoader resultLoader) {
        ...
        loaderMap.put(upperFirst, new cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair(property, metaResultObject, resultLoader));
    }

    public final Map<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair> getProperties() {
        return new HashMap<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair>(this.loaderMap);
    }
    ...
    public boolean load(String property) throws SQLException {
        cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair pair = loaderMap.remove(property.toUpperCase(Locale.ENGLISH));
        if (pair != null) {
            pair.load();
            return true;
        }
    ...
    public static class LoadPair implements Serializable {
        ...
        public void load(final Object userObject) throws SQLException {
            if (this.metaResultObject == null || this.resultLoader == null) {
                ...
                this.resultLoader = new ResultLoader(config, new cn.lnd.ibatis.executor.loader.ResultLoaderMap.ClosedExecutor(), ms, this.mappedParameter,
            ...
            if (this.serializationCheck == null) {
                ...
                this.resultLoader = new ResultLoader(old.configuration, new cn.lnd.ibatis.executor.loader.ResultLoaderMap.ClosedExecutor(), old.mappedStatement,
