...
import cn.lnd.ibatis.cache.TransactionalCacheManager;
...
public class CachingExecutor implements Executor {
    ...
    private cn.lnd.ibatis.executor.Executor delegate;
    private TransactionalCacheManager tcm = new TransactionalCacheManager();

    public CachingExecutor(cn.lnd.ibatis.executor.Executor delegate) {
