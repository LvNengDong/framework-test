...
public abstract class AbstractSerialStateHolder implements Externalizable {
    ...
    private Map<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair> unloadedProperties;
    ...
    public AbstractSerialStateHolder(
            ...
            final Map<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair> unloadedProperties,
            final ObjectFactory objectFactory,
            List<Class<?>> constructorArgTypes,
            List<Object> constructorArgs) {
        this.userBean = userBean;
        this.unloadedProperties = new HashMap<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair>(unloadedProperties);
    ...
    protected final Object readResolve() throws ObjectStreamException {
        ...
        try {
            ...
            this.unloadedProperties = (Map<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair>) in.readObject();
        ...
        final Map<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair> arrayProps = new HashMap<String, cn.lnd.ibatis.executor.loader.ResultLoaderMap.LoadPair>(this.unloadedProperties);
